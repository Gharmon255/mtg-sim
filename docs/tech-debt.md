...
- Commander casts are not wired into Rhystic Study / Mystic Remora / Esper Sentinel-style opponent-cast trigger windows yet because `tryCastCommander` does not currently call the successful-cast hook.
