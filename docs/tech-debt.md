...
- ReportGenerator surfaces stack/priority/Rhystic/Mystic summary metrics, but detailed stack history is intentionally not printed in normal reports yet.
