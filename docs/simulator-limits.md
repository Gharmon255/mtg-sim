...
- Smothering Tithe-style opponent draw wiring now uses deterministic heuristic pay-or-treasure decisions after the trigger resolves, but it does not model exact MTG payment timing and does not create a stack/priority window for the payment itself.
