...
- Triggered and activated window types exist, and narrow TurnEngine draw-step Smothering Tithe-style triggers, TurnEngine opponent-cast Rhystic Study-style triggers, and UpkeepEngine/AbilityResolver high-impact Monolith untap paths are wired, but production simulation does not broadly open every ability yet.
...
- Rhystic Study-style opponent-cast wiring is name/impact gated and does not model exact tax payment rules or every Mystic Remora / Esper Sentinel-style trigger yet.
